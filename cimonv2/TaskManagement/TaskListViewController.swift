    ...
    @objc func submitForm(){
        ...
        for i in 0..<form.allSections.count{
            ...
            if let sectionTag = form.allSections[i].tag {
                ...
                surveyResponses.append(SurveyResponseStruct(studyId: self.studyId, surveyId: self.surveyId, taskId: self.taskList[taskIndex].taskId, version: self.version, submissionTime: /*String(Date().timeIntervalSince1970)*/"", submissionTimeZone: "", answerType: responseType, answer: response))
            }
        }
